...
// RUN: not llvm-mc -triple=amdgcn %s -filetype=null -no-warn 2>&1 -mcpu=gfx1250 | FileCheck %s -implicit-check-not=error: -check-prefix=GFX1250-ERR
...
// GFX1250-ERR: :[[@LINE-2]]:1: error: operands are not valid for this GPU or mode
...
// GFX1250-ERR: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
